...
const { AutoCatcher } = require("./index");
...
try {
  ...
  await message.channel.send("❌ Failed to reload. Please check the logs.");
    ...
    if (!ac) return message.reply(`Unable to locate that  Mavuika!`);
    if (args[1]) {
    ...
    const embed = new EmbedBuilder()
      .setTitle("<a:MavuikaBoba:1379353951379394702> **__Mavuika Catcher__** ")
      .setColor("#dd633a") // orange color
      .setThumbnail(bot.user.displayAvatarURL())
      .setDescription(
              "***Here are all available commands***\n\n" +
          "<:dotflowerblue:1379353984552403004> **ping**              - Shows server latency\n" +
          "<:dotflowerblue:1379353984552403004> **help**              - Shows this help message\n" +
          "<:dotflowerblue:1379353984552403004> **reload**            - Reloads the autocatcher\n" +
          "<:dotflowerblue:1379353984552403004> **owner**             - Add/Remove/List owners\n" +
          "<:dotflowerblue:1379353984552403004> **add-token**         - Add or remove a token\n" +
          "<:dotflowerblue:1379353984552403004> **set-prefix**        - Set a new command prefix\n" +
          "<:dotflowerblue:1379353984552403004> **ai-catch**          - Catch Pokémon using AI\n" +
          "<:dotflowerblue:1379353984552403004> **catcher**           - Toggle autocatcher on/off\n" +
          "<:dotflowerblue:1379353984552403004> **m-start**           - Start market client\n" +
          "<:dotflowerblue:1379353984552403004> **m-stop**            - Stop market client\n" +
          "<:dotflowerblue:1379353984552403004> **transfer**          - Transfer coins to market client\n" +
          "<:dotflowerblue:1379353984552403004> **current-tokens**    - Show all current tokens"
        )   
